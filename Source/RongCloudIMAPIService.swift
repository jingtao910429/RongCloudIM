...
var rongCloudHeaderFields: Dictionary<String, String> = [
    "Content-Type": "application/json",
    "deviceType": "1",
//    "appVersion": rabbitVersion,
//    "customId": Utils.getValueFromUserDefault(key: "customId"),
    "apiVersion": "1"
]

var rongCloudAppendedParams: Dictionary<String, Any>?

func RongCloudJSONResponseDataFormatter(_ data: Data) -> Data {
    do {
...
//    }
    ...
    return Endpoint(url: url, sampleResponseClosure: {.networkResponse(200, target.sampleData)}, method: target.method, parameters: target.parameters)
        .adding(parameters: rongCloudAppendedParams ?? nil)
        .adding(newHTTPHeaderFields: rongCloudHeaderFields)
        .adding(parameterEncoding: target.parameterEncoding)
}

let rongCloudIMAPIProvider = RxMoyaProvider<RongCloudIMAPIService>(endpointClosure: endpointClosure, plugins: [NetworkLoggerPlugin(verbose: true, responseDataFormatter: RongCloudJSONResponseDataFormatter)])
