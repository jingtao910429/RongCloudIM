...
//        self.refreshUserInfoCache(name: name, portraitUri: portraitUri, userId: userId)
    ...
    public func sendMessageTypeMessage<T: RCMessageContent>(_ house: T, sendUserInfo: RCUserInfo, targetId: String) -> Observable<Bool>{
...
//        
        ...
        return sendMessages(targetId: targetId, sendUserInfo: sendUserInfo, content: house, pushContent: nil, pushData: nil)
    }
    
    public func sendTextMessage(targetId: String, sendUserInfo: RCUserInfo, content: String, extra: String) -> Observable<Bool> {
...
//        sendUserInfo.userId = Utils.getValueFromUserDefault(key: "customId")
        ...
        return sendMessages(targetId: targetId, sendUserInfo: sendUserInfo, content: textMsg, pushContent: nil, pushData: nil)
    }
    ...
    public func sendMessages(
        ...
        return Observable.create { [weak self] observer -> Disposable in
            ...
            RCIMClient.shared().sendMessage(RCConversationType.ConversationType_PRIVATE, targetId: targetId, content: content, pushContent: pushContent, pushData: pushData, success: { (messageId) in
                ...
                self?.sendMsgToServer(toUserId: targetId, sendUserInfo: sendUserInfo, content: content).subscribe(onNext: { (response) in
